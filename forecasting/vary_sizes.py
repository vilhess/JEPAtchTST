...
def main(cfg: DictConfig):
    ...
    for scratch, freeze_encoder in [(True, True), (False, True), (False, False)]:
        for keep_rate in [0.2, 0.5, 0.8, 1.]:
            cfg.scratch = scratch
            ...
            save_results(filename=f"results/mse_vary.json", dataset=f"{cfg.name}{ext}{keep_rate}", model=f"JePatchTST_{cfg.freeze_encoder}_{cfg.scratch}{rev}", score=total_loss)
